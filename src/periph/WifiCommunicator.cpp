...
*/
#define EXAMPLE_ESP_WIFI_SSID "MAUS"
#define EXAMPLE_ESP_WIFI_PASS "maus1234"
...
void wifi_init_sta(void)
{
    ...
    strcpy((char *)wifi_sta_config.ssid, "ssid");
    strcpy((char *)wifi_sta_config.password, "password");
    wifi_sta_config.threshold.authmode = WIFI_AUTH_WPA2_PSK;
