...
typedef enum _InfoCmdType {
	InfoCmdType_Drive = 0,
	InfoCmdType_TurnLeft = 1,
	InfoCmdType_TurnRight = 2,
	InfoCmdType_Stop = 3,
...
#define _InfoCmdType_MIN InfoCmdType_Drive
...
#define MsgControl_init_default                                                                    \
	{ 0, 0 }
#define MsgTurn_init_default                                                                       \
	{ 0, 0 }
#define MsgDrive_init_default                                                                      \
	{ 0, 0 }
#define MsgStop_init_default                                                                       \
	{ 0 }
#define MsgEncoderCallibration_init_default                                                        \
	{ 0, 0, 0, 0 }
...
#define NavigationPacket_init_zero                                                                 \
	{ false, SensorPacket_init_zero, false, Position_init_zero, 0, 0, 0, 0, 0, 0, 0 }
...
#define MsgControl_init_zero                                                                       \
	{ 0, 0 }
#define MsgTurn_init_zero                                                                          \
	{ 0, 0 }
#define MsgDrive_init_zero                                                                         \
	{ 0, 0 }
#define MsgStop_init_zero                                                                          \
	{ 0 }
#define MsgEncoderCallibration_init_zero                                                           \
	{ 0, 0, 0, 0 }
...
#define PidTuningInfo_FIELDLIST(X, a) X(a, CALLBACK, REPEATED, FLOAT, err, 1)
