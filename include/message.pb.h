...
/* Enum definitions */
typedef enum _MsgType { MsgType_Init = 0, MsgType_SensorData = 1, MsgType_Control = 2 } MsgType;
...
#define NavigationPacket_init_default                                                              \
	{ false, SensorPacket_init_default, false, Position_init_default }
...
#define NavigationPacket_init_zero                                                                 \
	{ false, SensorPacket_init_zero, false, Position_init_zero }
