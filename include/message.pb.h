...
/* Enum definitions */
typedef enum _MotorPosition { 
    MotorPosition_left = 0, 
    MotorPosition_right = 1 
} MotorPosition;
...
#define MsgMotorCalibration_init_default         {_MotorPosition_MIN, false, MsgEncoderCalibration_init_default}
#define MsgEncoderCalibration_init_default       {0, 0, 0, 0}
...
#define MausConfigPacket_init_default            {false, MsgEncoderCalibration_init_default, false, MsgEncoderCalibration_init_default, false, MsgEncoderCalibration_init_default}
...
#define MsgMotorCalibration_init_zero            {_MotorPosition_MIN, false, MsgEncoderCalibration_init_zero}
#define MsgEncoderCalibration_init_zero          {0, 0, 0, 0}
...
#define MausConfigPacket_init_zero               {false, MsgEncoderCalibration_init_zero, false, MsgEncoderCalibration_init_zero, false, MsgEncoderCalibration_init_zero}
...
X(a, STATIC,   FIXARRAY, FLOAT,    err,               1)
