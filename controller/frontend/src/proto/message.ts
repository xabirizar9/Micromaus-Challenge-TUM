...
export const SensorPacket = {
	...
	fromPartial<I extends Exact<DeepPartial<SensorPacket>, I>>(object: I): SensorPacket {
		const message = createBaseSensorPacket();
...
export const NavigationPacket = {
	...
	fromJSON(object: any): NavigationPacket {
		return {
			sensors: isSet(object.sensors) ? SensorPacket.fromJSON(object.sensors) : undefined,
			...
			rightEncoderTotal: isSet(object.rightEncoderTotal) ? Number(object.rightEncoderTotal) :
																   0,
	...
	toJSON(message: NavigationPacket): unknown {
		...
		message.sensors !== undefined &&
			(obj.sensors = message.sensors ? SensorPacket.toJSON(message.sensors) : undefined);
		message.position !== undefined &&
			(obj.position = message.position ? Position.toJSON(message.position) : undefined);
		message.leftMotorSpeed !== undefined && (obj.leftMotorSpeed = message.leftMotorSpeed);
		message.rightMotorSpeed !== undefined && (obj.rightMotorSpeed = message.rightMotorSpeed);
		...
		message.batPercentage !== undefined && (obj.batPercentage = message.batPercentage);
		message.timestamp !== undefined && (obj.timestamp = Math.round(message.timestamp));
		return obj;
	},

	fromPartial<I extends Exact<DeepPartial<NavigationPacket>, I>>(object: I): NavigationPacket {
		const message = createBaseNavigationPacket();
...
export const MausOutgoingMessage = {
	encode(message: MausOutgoingMessage, writer: Writer = Writer.create()): Writer {
	...
	fromJSON(object: any): MausOutgoingMessage {
		return {
			...
			nav: isSet(object.nav) ? NavigationPacket.fromJSON(object.nav) : undefined,
		};
	},
	...
	toJSON(message: MausOutgoingMessage): unknown {
		...
		message.nav !== undefined &&
			(obj.nav = message.nav ? NavigationPacket.toJSON(message.nav) : undefined);
		return obj;
	},

	fromPartial<I extends Exact<DeepPartial<MausOutgoingMessage>, I>>(object: I):
		MausOutgoingMessage {
			const message = createBaseMausOutgoingMessage();
			message.ack = object.ack !== undefined && object.ack !== null ?
				AckPacket.fromPartial(object.ack) :
				  undefined;
			message.nav = object.nav !== undefined && object.nav !== null ?
...
export const MsgControl = {
	...
	fromPartial<I extends Exact<DeepPartial<MsgControl>, I>>(object: I): MsgControl {
		const message = createBaseMsgControl();
...
export const MsgEncoderCallibration = {
	encode(message: MsgEncoderCallibration, writer: Writer = Writer.create()): Writer {
		if (message.kP !== 0) {
	...
	fromPartial<I extends Exact<DeepPartial<MsgEncoderCallibration>, I>>(object: I):
...
export const MausIncomingMessage = {
	encode(message: MausIncomingMessage, writer: Writer = Writer.create()): Writer {
		...
		if (message.encoderCallibration !== undefined) {
			MsgEncoderCallibration.encode(message.encoderCallibration, writer.uint32(34).fork())
				.ldelim();
		}
		return writer;
	},
			...
			switch (tag >>> 3) {
				...
				case 4:
					message.encoderCallibration =
						MsgEncoderCallibration.decode(reader, reader.uint32());
					break;
				default:
					reader.skipType(tag & 7);
					break;
	...
	fromJSON(object: any): MausIncomingMessage {
		return {
			...
			control: isSet(object.control) ? MsgControl.fromJSON(object.control) : undefined,
	...
	toJSON(message: MausIncomingMessage): unknown {
		...
		message.control !== undefined &&
			(obj.control = message.control ? MsgControl.toJSON(message.control) : undefined);
	...
	fromPartial<I extends Exact<DeepPartial<MausIncomingMessage>, I>>(object: I):
		MausIncomingMessage {
			const message = createBaseMausIncomingMessage();
			...
			message.control = object.control !== undefined && object.control !== null ?
				MsgControl.fromPartial(object.control) :
				  undefined;
			message.encoderCallibration =
				object.encoderCallibration !== undefined && object.encoderCallibration !== null ?
...
export type DeepPartial<T> = T extends Builtin ? T : T extends Array<infer U>?
	Array<DeepPartial<U>>:
	  T extends ReadonlyArray<infer U>? ReadonlyArray<DeepPartial<U>>: T extends {} ?
